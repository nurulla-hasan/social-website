...
const ActivitiesModalDemo = ({ isOpen, onConfirm, onCancel }: Props) => {
      ...
      <div className="max-w-3xl mx-auto bg-black text-white p-6 rounded-lg shadow-lg">
        <Form form={form} onFinish={handleSubmit} layout="vertical">
          ...
          <div className="flex justify-between items-center mt-4">
            <Form.Item name="privateActivity" valuePropName="checked">
            ...
            <Form.Item name="groupChat" valuePropName="checked">
              <input type="checkbox" className="w-4 h-4 mr-2" />
              <Text
                className="text-gray-400"
                style={{
          ...
          <Button
            htmlType="submit"
            className="w-full bg-purple-600 text-white mt-6 py-2"
          >
            Create Activity
          </Button>
        </Form>
...
export default ActivitiesModalDemo;
